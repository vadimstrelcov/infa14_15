...
public:
    ...
    void get_partition();
    void solve(double, const int, bool);
...
private:
    ...
    */
    ...
    void get_tmp_answer_parallel(vector<vector<double> >*, vector<vector<double> >*, double, bool);
	void data_exchange(vector<vector<double> > *, bool);
};
